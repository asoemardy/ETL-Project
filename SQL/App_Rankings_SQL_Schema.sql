...
ALTER TABLE "Publishers_Apps" ADD CONSTRAINT "fk_Publishers_Apps_Publisher_ID" FOREIGN KEY("Publisher_ID")
REFERENCES "Publishers" ("Publisher_ID");

ALTER TABLE "Publishers_Apps" ADD CONSTRAINT "fk_Publishers_Apps_iOS_App_ID" FOREIGN KEY("iOS_App_ID")
REFERENCES "iOS_Apps" ("iOS_App_ID");

ALTER TABLE "Publishers_Apps" ADD CONSTRAINT "fk_Publishers_Apps_Android_App_ID" FOREIGN KEY("Android_App_ID")
REFERENCES "Android_Apps" ("Android_App_ID");
